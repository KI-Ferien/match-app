        ...
        try {
            const response = await fetch("https://api.mistral.ai/v1/chat/completions", {
                ...
                body: JSON.stringify({
                    ...
                    messages: [{
                        role: "user", 
                        content: `Du bist ein Reise-Experte. Erstelle für ${vorname} eine persönliche Reise-Empfehlung für 2024. 
                        Details: Sternzeichen ${zodiacDe}, Lieblingsfarbe ${farbe}. 
                        Anforderungen: Max. 3 Sätze, inspirierend, nenne das Sternzeichen korrekt (niemals Krabbe für Krebs nutzen) und beziehe die Farbe dezent ein.`
                    }]
                })
            });
